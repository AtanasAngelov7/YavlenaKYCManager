...
Windows release 2026-09-01: еднофайловият installer е обновен до версия `0.1.1` и получава изричен Windows file-version `0.1.1.0`, така че най-новият файл може да бъде различен надеждно от предишния `0.1.0` build.
